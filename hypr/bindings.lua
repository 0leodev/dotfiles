...
o.bind("SUPER + SHIFT + B", "Browser", { launch = "/usr/bin/brave" })
--o.bind("SUPER + SHIFT + B", "Browser", { launch = "/usr/bin/brave-origin" })
...
--o.bind("SUPER + SHIFT + C", "Claude", { launch = "/usr/bin/brave-origin --app=https://claude.ai/new" }) --open from brave-origin
o.bind("SUPER + SHIFT + T", "Deepl", { webapp = "https://www.deepl.com/en/translator" })
...
o.bind("Delete", nil, "voxtype record toggle")
